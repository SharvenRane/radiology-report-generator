"""
Radiology Report Generator - Dataset
"""
import os
import torch
...
class RadiologyReportGeneratorDataset(Dataset):
    """Dataset for radiology report generator."""
...
def get_dataloader(root, split, config):
    ...
    dataset = RadiologyReportGeneratorDataset(root, split, transform)
    return DataLoader(
        dataset,
